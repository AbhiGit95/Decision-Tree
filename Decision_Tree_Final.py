...
def entropy(negatives, positives):
    ...
    if positives == 0 or negatives == 0:
        ...
        E = - (float(float(positives)/float(total))) * mt.log(float((float(positives)/float(total))),2) - (float(float(negatives)/float(total))) * mt.log(float((float(negatives)/float(total))),2)
    return E
